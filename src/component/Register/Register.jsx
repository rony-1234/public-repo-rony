    ...
    <div className="mb-4 flex flex-col gap-6">
      <div className="relative h-11 w-full min-w-[200px]">
        <input  
          ...
          bg-transparent px-3 py-3 font-sans text-sm 
          font-normal text-blue-gray-700 outline 
          outline-0 transition-all placeholder-shown:border
        ...
        left-0 -top-1.5 flex h-full w-full select-none text-[11px] font-normal
         ...
         after:border-t after:border-r after:border-blue-gray-200 
      ...
      <div className="relative h-11 w-full flex min-w-[200px]">
        <input  
        name="password" required
          ...
          placeHolder=" "
        />
        <span className="mt-4 absolute ml-72" onClick={() => SetShowPassword(!showPassword)}>
